...
export const experiences: TimelineViewerData[] = [
  ...
  {
    title: 'Founder & COO · ECHO Tech Organization',
    date: 'Aug 2023 – Present',
    description: `Co-founded ECHO Tech and led the execution of hackathons with 800+ participants, handling sponsorship acquisition, logistics coordination, and event operations end-to-end. Actively mentoring students and team members in backend development, machine learning, and deployment practices.`,
    latest: true,
  },
];
