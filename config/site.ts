export const siteConfig = {
  ...
  keywords: [
    ...
    'PyTorch',
    'Systems Engineer',
    'Shouriya Tayal Projects',
    'Shouriya Tayal Skills',
    'Shouriya Tayal Experience',
    'Shouriya Tayal Education',
    'Shouriya Tayal Contact',
    'Shouriya Tayal Resume',
  ],
  links: {
    ...
    resume: 'https://drive.google.com/file/d/1ReUhGvZ0BRuMK6nOiyWMX16Ni9fBy4yf/view?usp=sharing', // Add your resume link here
